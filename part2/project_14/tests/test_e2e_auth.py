...
user_data = {"username": "user_admin", "email": "admin@gmail.com", "password": "12345678", "role": "admin",
             "confirmed": True, "avatar": None}


def test_signup(client, monkeypatch):
    mock_send_email = Mock()
    monkeypatch.setattr("src.routes.auth_router.send_email", mock_send_email)
...
def test_not_confirmed_login(client):
    ...
    data = response.json()
    assert data["detail"] == "Account not confirmed"
